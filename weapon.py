...
class Fireball(pygame.sprite.Sprite):
    def __init__(self, image, x, y, target_x, target_y):
        ...
        self.dy = -(math.sin(math.radians(self.angle)) * constants.FIREBALL_SPEED)#negative because Ycoord increases down screen

    def update(self, screen_scroll, player):#we dont need obstacle detection here
        #reposition based on speed
        self.rect.x += screen_scroll[0] + self.dx
        self.rect.y += screen_scroll[1] + self.dy
